package net.com.bucketbackend.test;
...
import net.com.bucketbackend.dao.ProductDAO;
...
public class ProductTestCase {
	...
	public static void init() {
		...
		context.scan("net.com.bucketbackend");
		context.refresh();
	...
	public void testCRUDProduct() {
		...
		// list
		assertEquals("Something went wrong while fetching the list of products!", 10, productDAO.list().size());
